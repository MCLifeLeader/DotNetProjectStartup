...
public partial class StartupExampleContainer
{
    ...
    {
        modelBuilder.HasAnnotation("Scaffolding:ConnectionString", "Data Source=(local);Initial Catalog=StartupExample;Integrated Security=true");
        ...
        modelBuilder.Entity<Agency>(entity =>
        {
            ...
            entity.Property(e => e.CompanyLogoUrl)
                ...
                .HasMaxLength(250)
                .IsUnicode(false)
                .HasDefaultValueSql("'http://www.startupexample.com/images/defaultlogo.png'")
